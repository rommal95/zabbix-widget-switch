...
This is an fork of the original [Zabbix Switch Widget](https://github.com/Trikke76/zabbix-widget-switch), based on **Release 1.2.11**. All original functionality is preserved.
